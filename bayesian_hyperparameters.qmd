...
def new_range(trial, previous_study, param, 
              margin=0.3, lower_bound=None, upper_bound=None):
...
if os.path.exists("studies/xgb_stage1.pkl") and not FORCE_RERUN:
    ...
    xgb_study1.optimize(xgb_objective_stage1, n_trials=100)
...
def xgb_objective_stage2(trial):
    params = {
        ...
        "subsample": new_range(trial, xgb_study1, "subsample"),
...
if os.path.exists("studies/xgb_stage2.pkl") and not FORCE_RERUN:
    ...
    xgb_study2.optimize(xgb_objective_stage2, n_trials=50)
...
best_params = xgb_study1.best_params.update(xgb_study2.best_params)
...
if any(conditions):
    xgb_objective_stage3(best_params)
...
if os.path.exists("studies/lgb_stage1.pkl") and not FORCE_RERUN:
    ...
    lgb_study1.optimize(lgb_objective_stage1, n_trials=100)
...
def lgb_objective_stage2(trial):
    params = {
        ...
        "learning_rate": new_range(trial, lgb_study1, "learning_rate"),
...
if os.path.exists("studies/lgb_stage2.pkl")  and not FORCE_RERUN:
    ...
    lgb_study2.optimize(lgb_objective_stage2, n_trials=50)
...
best_params = lgb_study1.best_params.update(lgb_study2.best_params)
...
if os.path.exists("studies/cat_stage1.pkl") and not FORCE_RERUN:
    ...
    cat_study1.optimize(cat_objective_stage1, n_trials=100)
...
def cat_objective_stage2(trial):
    params = {
        ...
        "l2_leaf_reg": cat_study1.best_params["l2_leaf_reg"],
        "bagging_temperature": cat_study1.best_params["bagging_temperature"],
        "random_strength": cat_study1.best_params["random_strength"],
        "border_count": cat_study1.best_params["border_count"],
    }

    split_folder = 'training/catboost/step2/data'
    nested_folder = 'training/catboost/step2/data/training'
    cd_file = './higgs_data/train.cd'
...
if os.path.exists("studies/cat_stage2.pkl")  and not FORCE_RERUN:
    ...
    cat_study2.optimize(cat_objective_stage2, n_trials=50)
